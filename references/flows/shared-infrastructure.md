...
- **写作模式**：记录用户选择的写作模式（serial/subagent-parallel，当前默认 serial）
...
```bash
# 检查单个章节
python3 scripts/check_chapter_wordcount.py ./chinese-novelist/项目文件夹/第01章.md

# 检查所有章节
python3 scripts/check_chapter_wordcount.py --all ./chinese-novelist/项目文件夹/

# 自定义最小字数
python3 scripts/check_chapter_wordcount.py ./chinese-novelist/项目文件夹/第01章.md 3500
```
